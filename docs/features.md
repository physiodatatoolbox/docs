...
{% include image.html
    ...
    title= page.title
    caption="The IBI Sequence Analyzer, showing IBIs surrounding an event." %} 
...
{% include image.html
    ...
    title= page.title
    caption="The HRV module's GUI. The top graph shows the epochs, and the graph below that shows all IBI events, including any corrections made by the user. The bottom panel shows several HRV analyses performed on the selected epoch, such as IBI successive differences; Poincaré plot; and Lomb-Scargle periodogram." %} 
...
{% include image.html
    ...
    title= page.title
    caption="The BP Analyzer GUI, showing the BP signals and the estimated pulse." %} 
